...
beta_0 = st.slider("Enter beta_0 (intercept):",-50.0,50.0,0.0,step=0.5)  # Intercept
beta_1 = st.slider("Enter beta_1 (coefficient):",-10.0,10.0,1.0,step=0.5)  # Coefficient for feature x
