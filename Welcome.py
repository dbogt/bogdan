...
st.set_page_config(layout="wide",page_title='Bogdan Tudose',
menu_items={
        "About": f"Bogdan Python Demos"
        f"\nApp contact: [Bogdan Tudose](mailto:bogdan.tudose@trainingthestreet.com)"
    })
...
- :speech_balloon:[Board Game Cafe ChatBot](https://boardgamecafebot.streamlit.app/): Chatbot trained with OpenAI GPT to recommend board games to play at a cafe. [![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://boardgamecafebot.streamlit.app/)
"""
